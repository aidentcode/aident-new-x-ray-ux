...
export const getPrintOPGReportHtml = (origin: string) => {
...
export const opgPrint2 = (data: { email_id: string }) => {
    return `
               <tr>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                           <td align="left"
                              ...
                              Dentist’s Ai Dent TM email ID: ${data?.email_id}</td>
                        </tr>
                     </table>
                  </td>
               </tr>`;
